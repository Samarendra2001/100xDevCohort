...
function insertData() {
    return __awaiter(this, void 0, void 0, function () {
        var client, insertQuery, result, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    insertQuery = "INSERT INTO users1(name,email,password) VALUES('Sam','sam@gmail.com','samar@2001') RETURNING *";
                ...
                case 6:
                    _a.sent(); //closing the client connection
                    return [7 /*endfinally*/];
