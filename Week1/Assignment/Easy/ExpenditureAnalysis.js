...
function calculateTotalSpentByCategory(Transactions) {
  ...
  //even shorter way
    ...
    // });
  // Convert the catTotal object into an array of objects with category and totalSpent properties
     return Object.keys(catTotal).map(category => {
         return {
            category: category,
            totalSpent: catTotal[category]
            };
         });
    };
